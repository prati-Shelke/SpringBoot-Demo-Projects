...
import { patch, put } from '../../utils/http/httpMethods';
...
const EditProfile = ({EditProfileOpen,handleEditProfileClose}:any) =>
{
    ...
    const handleEditProfile = async() =>
    {
        ...
        const res = await patch("http://localhost:8080/users/edit-profile",CurrentUser);
        ...
        // const token="eyJhbGciOiJIUzUxMiJ9.eyJzdWIiOiJwcmF0aWtzaGFAYW5ndWxhcm1pbmRzLmluIiwiZXhwIjoxNjU4MTc4NjkxLCJpYXQiOjE2NTgxNDI2OTF9.m8kxTi9k9PLprEPOvpK9IPP8dEIn7pjnLJ1QaLmxYe-HlwQFXbEmPzwhO5NNHhFQbQP5qAtuNBFZ2ToE7Hui-Q"

        // Axios.patch("http://localhost:8080/users/edit-profile",CurrentUser,{
        //     headers:{
    ...
    const handleUploadProfileImg = async(file:any) =>
    {
        ...
        const res:any = await patch("http://localhost:8080/users/edit-profileImg",formdata);
        console.log(res)
                ...
                <Box >
                    <Card id="editModal">
                        ...
                        <div style={{marginTop:'-10px',cursor:'pointer'}} onClick={handleMenu}  >
                            <Avatar sx={{width:'80px',height:'80px'}} src={ImageFile===false ? `${CurrentUser.profileImg}` : Preview} />
